...
export default class Overlay extends React.Component {
    startMessageSequence(timer) {
        if (timer === Number(this.props.displaySystemsOnlineMsgTime.toString().slice(0,-2))) { //Then once the ship is ready to restart booster, we display the "all systems online message".
